...
SWEP.Description = ARC9:GetPhrase("eft_weapon_mcxspear_desc")
...
SWEP.CustomizePos = Vector(19, 42, 4)
SWEP.CustomizeSnapshotFOV = 55
SWEP.CustomizeRotateAnchor = Vector(19, -4.28, -5.23)
SWEP.CustomizeSnapshotPos = Vector(0, 23, 0)
...
SWEP.ShootSound = { path .. "fire_new/mcx_spear_outdoor_close_loop1.wav", path .. "fire_new/mcx_spear_outdoor_close_loop2.wav", path .. "fire_new/mcx_spear_outdoor_close_loop3.wav", path .. "fire_new/mcx_spear_outdoor_close_loop4.wav" }
SWEP.LayerSound = path .. "fire_new/mcx_spear_outdoor_close_loopt.wav"

SWEP.ShootSoundSilenced = { path .. "fire_new/mcx_spear_outdoor_silenced_close_loop1.wav", path .. "fire_new/mcx_spear_outdoor_silenced_close_loop2.wav", path .. "fire_new/mcx_spear_outdoor_silenced_close_loop3.wav", path .. "fire_new/mcx_spear_outdoor_silenced_close_loop4.wav" }
SWEP.LayerSoundSilenced = path .. "fire_new/mcx_spear_outdoor_silenced_close_loopt.wav"

SWEP.ShootSoundIndoor = { path .. "fire_new/mcx_spear_indoor_close_loop1.wav", path .. "fire_new/mcx_spear_indoor_close_loop2.wav", path .. "fire_new/mcx_spear_indoor_close_loop3.wav", path .. "fire_new/mcx_spear_indoor_close_loop4.wav" }
SWEP.LayerSoundIndoor = path .. "fire_new/mcx_spear_indoor_close_loopt.wav"

SWEP.ShootSoundSilencedIndoor = { path .. "fire_new/mcx_spear_indoor_silenced_close_loop1.wav", path .. "fire_new/mcx_spear_indoor_silenced_close_loop2.wav", path .. "fire_new/mcx_spear_indoor_silenced_close_loop3.wav", path .. "fire_new/mcx_spear_indoor_silenced_close_loop4.wav" }
SWEP.LayerSoundSilencedIndoor = path .. "fire_new/mcx_spear_indoor_silenced_close_loopt.wav"

SWEP.DistantShootSound = { path .. "fire_new/mcx_spear_outdoor_distant_loop1.wav", path .. "fire_new/mcx_spear_outdoor_distant_loop2.wav" }
SWEP.DistantShootSoundSilenced = { path .. "fire_new/mcx_spear_outdoor_silenced_distant_loop1.wav", path .. "fire_new/mcx_spear_outdoor_silenced_distant_loop2.wav" }
SWEP.DistantShootSoundIndoor = { path .. "fire_new/mcx_spear_indoor_distant_loop1.wav", path .. "fire_new/mcx_spear_indoor_distant_loop2.wav" }
SWEP.DistantShootSoundSilencedIndoor = { path .. "fire_new/mcx_spear_indoor_silenced_distant_loop1.wav", path .. "fire_new/mcx_spear_indoor_silenced_distant_loop2.wav" }
...
local rst_tac = {
    { s = randspin, t = 0.12 - 4/27 },
    { s = "arc9_eft_shared/weap_magrelease_button.ogg", t = 0.3 - 4/27 },
    { s = "arc9_eft_shared/weap_magout_plastic.ogg", t = 0.47 - 4/27 },
    { s = pouchout, t = 0.99 - 4/27 },
    { s = randspin, t = 1.06 - 4/27 },
    { s = path .. "fiveseven_mag_rattle2.ogg", t = 1.47  - 4/27},
    { s = "arc9_eft_shared/weap_magin_plastic.ogg", t = 1.92 - 4/27 },
    { s = randspin, t = 2.3 - 4/27 },
    {hide = 0, t = 0},
    {hide = 1, t = 0.5},
    {hide = 0, t = 1.0}
}
...
local rst_tac5 = {
    ...
    { s = randspin, t = 1.06 - 4/27 },
    { s = path .. "fiveseven_mag_rattle2.ogg", t = 1.47 - 4/27 },
    { s = "arc9_eft_shared/weap_magin_plastic.ogg", t = 1.92+0.1 - 4/27 },
    { s = randspin, t = 2.3+0.1 - 4/27 },
    {hide = 0, t = 0},
    {hide = 1, t = 0.5},
    {hide = 0, t = 1.0}
}
