...
function ENT:Initialize()
	self:SetModel( "models/crunchy/props/borderlands_props/dahlammocrate_opened_meds.mdl")
	...
	for i = math.random(1, 3),1,-1 do 
		...
		elseif (loottype == 4) then 
			loottype_name = "other_morphine"
		elseif (loottype == 5) then 
			loottype_name = "other_blood_bag"
		elseif (loottype == 6) then 
			loottype_name = "csgo_armor_full"
		end
